...
if isempty(preset_name)
    ...
    settings.mini_amp_range = [0 inf]; % deltaF/F - max amplitude to exclude massive unknown events
    settings.mini_peak_prominence = 10; % optional criteria, peak prominence, set to 0 to turn off
    % Filtering
