...
%         show_legend = 0;
%     end
    plotROIfunc(func_output,in.plot_func,func_output.stim_frames,...
                    ...
                    'stim_pulse_dur',exp_settings.stim_pulse_dur_sec,...
                    'indicator_dir',in.indicator_dir,'peak_align',in.roi_func_peak_align,...
                    'stim_frames2',exp_settings.stim_vals2,...
                    'stim_pulse_dur2',exp_settings.stim_pulse_dur2_sec,...
                    'roi_colors',in.roi_func_line_cols);
    drawnow; 
