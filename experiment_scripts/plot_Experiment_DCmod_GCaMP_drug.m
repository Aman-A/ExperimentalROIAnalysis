...
%%
ps.condition = sprintf('%s_20mAB_-100VpmG',drug_name);
...
roiset_filename_no_ext = getROIset_name(roiset_filename,...
                                         ps.transform_type,...
                                            ps.registration_rec);  
amps = [-50,50];
conditions = numericVec2chars(amps,sprintf('%s_20mAB_%%gVpmG',drug_name)); 
...
summary_fig_dir = fullfile(data_fold,exp_date,reporter,dish,...
                            ['figs_',drug_name,'_',roiset_filename_no_ext]);
summary_datafile = sprintf('%s_%s_%s_%s_%s_%s_train',exp_date,reporter,dish,ps.roi_func_mode,...
                                    roiset_filename_no_ext,drug_name);
...
roiset_filename_no_ext = getROIset_name(roiset_filename,...
                                         ps.transform_type,...
                                            ps.registration_rec);                        
data_file_suffix = [drug_name '_train'];
analysis_fig_fold = ['figs_' drug_name '_' roiset_filename_no_ext];
