function runArchonExperimentAnalysis(def_or_dataset_def_filename,conditions,...
                            roi_func_modes,exp_settings,plot_settings,varargin)
%RUNarchonEXPERIMENTANALYSIS Runs analyis on experiments in multiple dishes,
...
in.extra_exp_settings = []; % ExperimentSettings for different trials (e.g. train, APwave)
