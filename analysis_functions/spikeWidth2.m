function spike_width = spikeWidth2(t,y,stim_index,width_val,plot_fig) %#codegen
...
%   width_val : scalar
%       fixed amplitude at which to compute width, e.g. 0.05 deltaF/F0
%   Optional Inputs 
%   --------------- 
%   Outputs 
%   ------- 
...
if plot_fig
    ...
    plot([t(1),t(end)],width_val*[1 1],'--r','DisplayName',sprintf('%g %%',width_val*100));
